-) — AI 编码助手 Skill，在 AI Agent 中输入 `/graphify .` 即可将整个项目——代码、文档、PD…
- [Understand-Anything](#2-egonex-aiunderstand-anything-72k-) — Claude Code 插件，通过多 Agent 管线分析整个项目，构建包含每个文件、函数、类和依赖的知识图谱，并提供交…
>>>>>>> ed330c2 (chore: update code-understanding-top-stars 2026-07-08)
- [codegraph](#4-colbymchenrycodegraph-58k-) — 预索引代码知识图谱，为 AI Agent 提供精准上下文
...
- [semgrep](#15-semgrepsemgrep-16k-) — 面向代码的语义 grep
- [codeql](#17-githubcodeql-98k-) — 代码查询语言与分析平台，驱动 GitHub Advanced Security 的代码扫描功能
- [joern](#21-joerniojoern-33k-) — 开源代码分析平台，用于分析源码、字节码和二进制可执行文件

### 📝 API 提取与文档生成

- [context7](#3-upstashcontext7-59k-) — 为 LLM 和 AI 代码编辑器提供最新代码文档的上下文平台
- [GitNexus](#6-abhigyanpatwarigitnexus-44k-) — 为 Agent 上下文构建"代码神经系统"
...
- [deepwiki-rs](#23-sopacodeepwiki-rs-13k-) — 将代码变为清晰文档
- [CodeWiki](#24-fsoft-ai4codecodewiki-13k-) — ACL 2026 论文开源项目——面向大规模代码库的整体结构化文档生成框架

### 🔌 CLI 转化与框架

- [CLI-Anything](#5-hkudscli-anything-45k-) — "今天的软件服务人类👨‍💻，明天的用户是 Agent🤖"——弥合 AI Agent 与世界软件的鸿沟
- [python-fire](#9-googlepython-fire-28k-) — 从任意 Python 对象自动生成命令行接口
- [oclif](#18-oclifoclif-96k-) — Node.js CLI 框架，用于生成、构建和发布命令行工具

### 🔍 代码审查与语义搜索

- [graphiti](#8-getzepgraphiti-28k-) — 为 AI Agent 构建实时知识图谱，支持时序记忆与动态关系更新
- [code-review-graph](#12-tirth8205code-review-graph-19k-) — 停止烧 Token，开始智能审查
- [networkx](#14-networkxnetworkx-17k-) — Python 生态最主流的图论与复杂网络分析库，提供图算法、生成与可视化能力，常被代码图谱工具用作底层数据结构
- [open-code-review](#16-alibabaopen-code-review-10k-) — 开源 AI 代码审查 CLI
- [semble](#19-minishlabsemble-55k-) — 面向 Agent 的快速精准代码搜索工具
<<<<<<< HEAD
- [RepoAgent](#25-openbmbrepoagent-997-) — LLM 驱动的仓库 Agent，帮助开发者与团队快速生成文档、梳理模块结构并理解代码库全貌
=======
- [RepoAgent](#25-openbmbrepoagent-1k-) — LLM 驱动的仓库 Agent，帮助开发者与团队快速生成文档、梳理模块结构并理解代码库全貌
>>>>>>> ed330c2 (chore: update code-understanding-top-stars 2026-07-08)
