...
> 来源：[wind8ai 的 code-understanding 列表](https://github.com/stars/wind8ai/lists/code-understanding) · 更新：2026-07-21
...
- [graphify](#1-graphify-labsgraphify-93k-) — AI 编码助手 Skill，在 AI Agent 中输入 `/graphify .` 即可将整个项目——代码、文档、PD…
- [Understand-Anything](#2-egonex-aiunderstand-anything-75k-) — Claude Code 插件，通过多 Agent 管线分析整个项目，构建包含每个文件、函数、类和依赖的知识图谱，并提供交…
- [codegraph](#3-colbymchenrycodegraph-61k-) — 预索引代码知识图谱，为 AI Agent 提供精准上下文
...
- [code-review-graph](#12-tirth8205code-review-graph-24k-) — 停止烧 Token，开始智能审查
...
- [open-code-review](#16-alibabaopen-code-review-11k-) — 开源 AI 代码审查 CLI
...
- [archguard](#26-archguardarchguard-670-) — 架构治理工作台，支持容器/组件/代码多级架构分析、架构适应度函数与系统依赖洞察，面向架构梳理与治理场景
