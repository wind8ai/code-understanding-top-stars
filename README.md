...
### 🏗️ 代码图谱 & 架构分析
- [graphify](#2-graphify-547k-) — 代码/文档 → 可查询知识图谱 + 调用流
- [GitNexus](#4-gitnexus-405k-) — CLI+MCP 代码神经系统，Agent 集成
- [codegraph](#5-codegraph-293k-) — 预索引代码知识图谱，本地优先
- [tree-sitter](#9-tree-sitter-256k-) — 底层解析基石，200+ 语言 AST/CST
- [code-review-graph](#11-code-review-graph-175k-) — 本地代码图谱，爆炸半径分析
- [joern](#17-joern-32k-) — 代码属性图（CPG）分析平台
- [codeql](#13-codeql-96k-) — 代码查询语言，GitHub 官方
- [semgrep](#12-semgrep-153k-) — 语义 grep，多语言模式匹配

### 📝 API 提取 & 文档生成
- [context7](#1-context7-562k-) — LLM 实时代码文档上下文
- [smart-doc](#18-smart-doc-16k-) — Java 零侵入 API 文档，源码分析
- [OpenDeepWiki](#16-opendeepwiki-33k-) — AI 驱动仓库 → Wiki + MCP
- [deepwiki-rs](#20-deepwiki-rs-1k-) — Rust 代码文档引擎
...
### 🔌 CLI 转化 & 框架
- [CLI-Anything](#3-cli-anything-408k-) — 软件 → Agent-Native CLI
- [python-fire](#7-googlepython-fire-282k-) — Python 对象 → CLI
- [oclif](#14-oclif-95k-) — Node.js CLI 框架（Heroku/Salesforce）
- [swagger-codegen](#10-swagger-codegen-177k-) — Swagger → 代码/CLI

### 🔍 代码搜索 & Token 优化
- [semble](#15-semble-44k-) — Agent 语义代码搜索，省 98% token
- [code-review-graph](#11-code-review-graph-175k-) — 爆炸半径分析，省 6.8-49× token
- [codegraph](#5-codegraph-293k-) — 预索引图谱，减少工具调用
...
*数据截至 2026-05-27，星数取自 GitHub 页面公开信息*
