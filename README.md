...
- [graphify](#1-graphify-labsgraphify-105k-) — AI 编码助手 Skill，在 AI Agent 中输入 `/graphify .` 即可将整个项目——代码、文档、PD…
- [Understand-Anything](#2-egonex-aiunderstand-anything-79k-) — Claude Code 插件，通过多 Agent 管线分析整个项目，构建包含每个文件、函数、类和依赖的知识图谱，并提供交…
- [codegraph](#3-colbymchenrycodegraph-66k-) — 预索引代码知识图谱，为 AI Agent 提供精准上下文
- [GitNexus](#6-abhigyanpatwarigitnexus-45k-) — 为 Agent 上下文构建"代码神经系统"
- [code-review-graph](#8-tirth8205code-review-graph-30k-) — 停止烧 Token，开始智能审查
- [tree-sitter](#12-tree-sittertree-sitter-27k-) — 增量解析器生成工具与解析库——几乎所有现代代码分析工具的底层基石
- [semgrep](#16-semgrepsemgrep-16k-) — 面向代码的语义 grep
- [codeql](#17-githubcodeql-99k-) — 代码查询语言与分析平台，驱动 GitHub Advanced Security 的代码扫描功能
- [code-graph-rag](#20-vitali87code-graph-rag-37k-) — 面向多语言 monorepo 的代码知识图谱与 RAG 工具，使用 Tree-sitter 解析代码并将结构关系写入 M…
...
- [CodeWiki](#24-fsoft-ai4codecodewiki-15k-) — ACL 2026 论文开源项目——面向大规模代码库的整体结构化文档生成框架
- [redocly-cli](#25-redoclyredocly-cli-15k-) — 让 OpenAPI 开发变得简单的 CLI 工具

### 🔌 CLI 转化与框架

- [CLI-Anything](#5-hkudscli-anything-47k-) — "今天的软件服务人类👨‍💻，明天的用户是 Agent🤖"——弥合 AI Agent 与世界软件的鸿沟
- [python-fire](#10-googlepython-fire-28k-) — 从任意 Python 对象自动生成命令行接口
- [oclif](#18-oclifoclif-96k-) — Node.js CLI 框架，用于生成、构建和发布命令行工具

### 🔍 代码审查与语义搜索

- [graphiti](#7-getzepgraphiti-30k-) — 为 AI Agent 构建实时知识图谱，支持时序记忆与动态关系更新
- [code-review-graph](#8-tirth8205code-review-graph-30k-) — 停止烧 Token，开始智能审查
- [open-code-review](#13-alibabaopen-code-review-20k-) — 开源 AI 代码审查 CLI
...
- [archguard](#27-archguardarchguard-672-) — 架构治理工作台，支持容器/组件/代码多级架构分析、架构适应度函数与系统依赖洞察，面向架构梳理与治理场景
