...
> 来源：[wind8ai 的 code-understanding 列表](https://github.com/stars/wind8ai/lists/code-understanding) · 更新：2026-09-13
...
- [codegraph](#3-colbymchenrycodegraph-71k-) — 预索引代码知识图谱，为 AI Agent 提供精准上下文
...
- [deepwiki-rs](#23-sopacodeepwiki-rs-26k-) — 将代码变为清晰文档
...
- [open-code-review](#13-alibabaopen-code-review-23k-) — 开源 AI 代码审查 CLI
- [networkx](#15-networkxnetworkx-17k-) — Python 生态最主流的图论与复杂网络分析库，提供图算法、生成与可视化能力，常被代码图谱工具用作底层数据结构
- [semble](#19-minishlabsemble-61k-) — 面向 Agent 的快速精准代码搜索工具
